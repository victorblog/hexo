---
title: Redis应用场景之抢红包系统(二)
date: 2018.06.19 13:06
tags:
  - 分布式中间件
description: Redis应用场景之抢红包系统(二)
toc: true
copyright: true
...
![](Redis应用场景之抢红包系统-二/抢红包系统处理用户请求过程和数据流向.jpeg)
...
- 使用PostMan测试接口结果如下：
  ...
  ![](Redis应用场景之抢红包系统-二/发红包的PostMan测试结果.png)
...
- 查看数据库记录
  ...
  ![](Redis应用场景之抢红包系统-二/查看红包记录表.png)

  - 查看红包明细表

    ![](Redis应用场景之抢红包系统-二/查看红包明细表.png)

  - 汇总红包明细表的金额与总金额对比

    ![](Redis应用场景之抢红包系统-二/汇总红包明细表与总金额对比.png)
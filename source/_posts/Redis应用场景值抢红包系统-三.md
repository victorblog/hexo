...
![](Redis应用场景之抢红包系统-三/抢红包业务模块整体开发流程.jpeg)
...
- 使用PostMan测试接口结果如下：
  ...
  ![](Redis应用场景之抢红包系统-三/postman测试抢红包.png)

  ![](Redis应用场景之抢红包系统-三/红包被抢光.png)
...
- 查看数据库记录
  ...
  - 查看抢红包表
    ...
    ![](Redis应用场景之抢红包系统-三/抢到红包的用户记录信息.png)

  - 汇总红包明细表的金额与总金额对比

    ![](Redis应用场景之抢红包系统-三/抢到红包用户的总金额.png)
